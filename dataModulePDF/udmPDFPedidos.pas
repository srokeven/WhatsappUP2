...
type
  TdmPDFPedidos = class(TDataModule)
    ...
    qrMainVALOR_BRUTO: TFMTBCDField;
    qrMainVALOR_DESCONTO: TFMTBCDField;
    qrMainVALOR_LIQUIDO: TFMTBCDField;
    qrMainVALOR_RECEBIDO: TFMTBCDField;
    qrMainVALOR_TROCO: TFMTBCDField;
    qrMainVALOR_FRETE_AGREGADO: TFMTBCDField;
    qrMainVALOR_ABATIDO_FRETE: TFMTBCDField;
    ...
    qrMainWHATSAPP: TWideStringField;
    ...
    qrClienteLIMITECREDITO: TFMTBCDField;
    ...
    qrClienteCREDITO: TFMTBCDField;
    qrClienteUSUARIOS_ID: TIntegerField;
    qrClienteDATAHORA_ATUALIZADO: TSQLTimeStampField;
    qrClienteCADASTRO_MATRIZ_ID: TIntegerField;
    qrClienteTEXTO_GARANTIA: TWideStringField;
    qrClienteUSAR_GARANTIA: TSmallintField;
    qrClienteWHATSAPP: TWideStringField;
    qrClienteDATA_NOTIFICACAO: TDateField;
    ...
    qrDetailVALOR_UNITARIO: TFMTBCDField;
    qrDetailVALOR_DESCONTO: TFMTBCDField;
    qrDetailVALOR_ACRESCIMO: TFMTBCDField;
    qrDetailQUANTIDADE: TFMTBCDField;
    qrDetailVALOR_TOTAL: TFMTBCDField;
    qrDetailHISTORICO: TWideStringField;
    qrDetailORDEM: TIntegerField;
    qrDetailLOCALIZACAO: TWideStringField;
    qrDetailPRECO_VENDA: TFMTBCDField;
    qrDetailPRECO_VENDA_PRZ: TFMTBCDField;
    qrDetailPRECO_VENDA_ATA: TFMTBCDField;
    qrDetailPRECO_VENDA_ATA_PRZ: TFMTBCDField;
    qrDetailMARCA_DESCRICAO: TWideStringField;
    qrSubDetailID: TIntegerField;
    ...
    qrSubDetailVALOR_PAGAMENTO: TFMTBCDField;
